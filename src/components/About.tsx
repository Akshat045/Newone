  ...
  const values = [
    {
      ...
      description:
        "Every piece is carefully crafted by skilled artisans in India, carrying forward centuries-old traditions.",
      color: "text-rose-500",
    },
    {
      ...
      description:
        "We use only the finest materials and rigorous quality checks to ensure lasting beauty.",
    ...
    },
    {
      ...
      description:
        "Rooted in the rich jewelry-making traditions of India, blending ancient techniques with modern designs.",
    ...
    },
    {
      ...
      description:
        "Your satisfaction is our priority. We build lasting relationships, not just transactions.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          ...
          <p className="text-xl text-gray-600 leading-relaxed font-crimson">
            Born from a passion for exquisite craftsmanship and inspired by
            India&apos;s rich jewelry heritage, Elegant Gems has been creating
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                <p>
                  Founded in the heart of Delhi&apos;s vibrant Karol Bagh, our
                  journey began with a simple belief: jewelry should be more
                  than an accessory—it should be a celebration of your unique
                  story.
                </p>
                <p>
                  Drawing inspiration from India&apos;s centuries-old traditions
                  of jewelry making, we combine time-honored techniques with
                  contemporary designs. Each piece in our collection reflects
                  the skill of master craftsmen who have inherited their art
                  through generations.
                </p>
                <p>
                  From the bustling markets of Jaipur to the diamond cutting
                  centers of Surat, we source the finest materials and work with
                  the most skilled artisans to bring you jewelry that embodies
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Recognized by Indian Jewelry Association 2024
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="col-span-2 relative aspect-[4/3] rounded-2xl overflow-hidden shadow-xl">
                ...
                <div className="absolute bottom-4 left-4 text-white">
                  ...
                  <p className="text-sm opacity-90">
                    Creating perfection since 1995
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`inline-flex p-4 rounded-full bg-gray-50 mb-6`}
                  >
            ...
            {[
              {
                ...
                description:
                  "Every piece begins with a vision, carefully sketched and refined by our design team.",
                image:
                  "https://images.unsplash.com/photo-1583292651514-3a3b36e05b23?w=400&h=300&fit=crop&crop=center",
              },
              {
                step: "02",
                title: "Handcrafting",
                description:
                  "Master artisans bring the design to life using traditional techniques passed down through generations.",
                image:
              ...
              },
              {
                ...
                image:
                  "https://images.unsplash.com/photo-1602173574767-37ac01994b2a?w=400&h=300&fit=crop&crop=center",
              },
            ].map((process, index) => (
                ...
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-lg mb-6 group-hover:shadow-xl transition-shadow duration-300">
                  ...
                  <div className="absolute top-4 left-4">
                    <div className="bg-white/90 backdrop-blur-sm rounded-full w-12 h-12 flex items-center justify-center">
                      <span className="text-lg font-bold text-amber-600 font-playfair">
                        {process.step}
                      </span>
                    </div>
                  </div>
